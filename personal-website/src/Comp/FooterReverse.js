...
import './Comp-css/FooterReverse.css';
...
function Footer() {
  ...
  return (
    <div className='footerParent1'>
      <div className='contOne1'>
            <h2 className='abt1'>Made with love, using:</h2>
            <div className='tech1'>
                <div className='icn1 react1'>
                    {reactIcon}
                </div>
                <div className='icn1 node1'>
                    {nodeIcon}
                </div>
                <div className='icn1 mongoDb1'>
                    {mongo}
                </div>
            </div>
      </div>
      <div className='contTwo1'>
        <h2 className='abt1'>Site links:</h2>
        <div className='link1'>
          <ul className='linkList1'>
            <li><a className='lnk1'>Home</a></li>
            <li><a className='lnk1'>About Me</a></li>
            <li><a className='lnk1'>My Work</a></li>
            <li><a className='lnk1'>Documentation & Contact</a></li>
            <li><a className='lnk1'>Login & Singup</a></li>
          </ul>         
        </div>
      </div>
      <div className='contThree1'>
        <h2 className='abt1'>Contact & Info:</h2>
        <div className='clnk1'>
          <ul className='contLinks1'>
            <li><a className='lnkCon1' onMouseOver={() => whoIsHovered(1)} onMouseLeave={() => setImageNum(0)} href='https://www.linkedin.com/in/andi-morina-6742192b1/'>LinkedIn</a></li>
            <li><a className='lnkCon1' onMouseOver={() => whoIsHovered(2)} onMouseLeave={() => setImageNum(0)} href='https://github.com/DevAndi-m'>GitHub</a></li>
            <li><a className='lnkCon1' onMouseOver={() => whoIsHovered(3)} onMouseLeave={() => setImageNum(0)} href='https://www.facebook.com/andi.morina.9/'>Facebook</a></li>
            <li><a className='lnkCon1' onMouseOver={() => whoIsHovered(4)} onMouseLeave={() => setImageNum(0)} href='https://www.instagram.com/morina_andii/'>Instagram</a></li>
          </ul>
          <div className='qrSec1'>
            <p className='qrTxt1'>{qrState}</p>
            <div className='qrHolder1'>
              <img src={image}></img>
            </div>
          </div>
        </div>
